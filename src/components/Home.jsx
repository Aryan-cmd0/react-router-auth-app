  ...
  return (
    <div style={{ fontFamily: "inherit", minHeight: "100vh" }}>
      ...
      <section style={{ textAlign: "center", padding: "60px 28px 44px" }}>
        ...
        >
          Where <span style={{ color: "#7F77DD" }}>dev ideas</span>
          <br />
          come to life
        </h1>
        ...
        {/* Search */}
        <div
          style={{ maxWidth: 440, margin: "0 auto 24px", position: "relative" }}
        >
          <input
            type="text"
        ...
        {[
          {
            ...
            lblColor: "#534AB7",
            descColor: "#7F77DD",
            num: `${posts.length.toLocaleString()}`,
            lbl: "Total posts",
            desc: "+48 this week",
          },
          {
